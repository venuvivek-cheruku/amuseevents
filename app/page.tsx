...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Amuse Events — London Event Planning & DJ Nights",
    description:
      "Weddings, corporate events, kids parties, and London DJ nights. Calm planning. Joyful days.",
  ...
  twitter: {
    ...
    title: "Amuse Events — London Event Planning & DJ Nights",
    description:
      "Weddings, corporate events, kids parties, and London DJ nights.",
  },
};

const REVIEWS = [
  {
    text: '"Calm, brilliant, fairly priced. Got back to me on a Sunday afternoon."',
    initials: "JM",
    name: "Jess Mitchell",
    where: "60th birthday · Twickenham",
  },
  {
    text: '"Booked them for our launch. Marquee, sound, food — one team, zero stress."',
    initials: "RA",
    name: "Raj Aggarwal",
    where: "Product launch · Soho",
  },
  {
    text: '"My daughter still talks about the magician. Best money we spent on her sixth."',
    initials: "SO",
    name: "Sara O'Connell",
    where: "Kids party · Hounslow",
  },
];
...
const JOURNAL_TEASERS = [
  {
    ...
    category: "Trends",
    meta: "3 min read",
    title: "What's actually changing in spring 2026 weddings",
    body: "Less white tents, more dinner-plate moments. A field report from our last six bookings.",
  },
  {
    imageLabel: "Pricing & honesty",
    ...
    <>
        ...
        <div className="container">
          <div className="hero-split-home">
            <div>
              ...
              <p className="lede lede-gap max-w-[48ch] pt-8" data-hero="lede">
                We design, build and run weddings, parties and corporate moments
                across London. You enjoy the day. We hold the rest.
              </p>
            ...
            <div className="home-gallery">
              ...
              <div
                className="ph amber-tint reveal"
                data-label="Garden party · Twickenham"
              />
            </div>
          </div>
          ...
          <Reveal className="stats-row stats-top-border">
            <div className="stat amber">
              <div className="n">
                11<span className="stat-suffix">yrs</span>
              </div>
            ...
            <div className="stat">
              <div className="n">
                4.9
                <IconStar className="icon-stat-star" aria-hidden="true" />
              </div>
              <div className="l">Average across 213 reviews</div>
            </div>
            <div className="stat">
              <div className="n">
                98<span className="stat-suffix">%</span>
              </div>
        ...
        <div className="container">
          <Reveal className="section-heading-row mb-14">
            ...
            <p className="lede max-w-95">
              Ten services. One team. Whether it's a five-year-old's party or a
              300-guest gala — we plan it the same calm way.
            </p>
          </Reveal>
          ...
          <Reveal className="service-mosaic">
            ...
            <Link
              ...
              className="service-card mosaic-3x1"
            >
            ...
            <Link
              ...
              className="service-card mosaic-4x1"
            >
              <div
                className="ph dark"
                data-label="Production · marquee · lighting"
              />
              <div className="gradient" />
              <span className="arrow-circle">
                <IconArrowUpRight aria-hidden="true" />
          ...
          <div className="content-split">
            ...
            <Reveal>
              <SectionHeading eyebrow="03 — the studio">
                The people on the
                <br />
                <em className="italic">phone</em> are the people
                <br />
                on the <em className="italic">day</em>.
              </SectionHeading>
              <p className="lede lede-gap">
                We're a small Isleworth-based team — eleven years deep, nothing
                sub-contracted. The voice you fall for in the consultation is
                the same one keeping things calm at 11pm when the rain starts.
              </p>
        ...
        <div className="container">
          <Reveal className="section-heading-row mb-16">
            <SectionHeading eyebrow="04 — the process">
              From <em className="italic">"is this a good idea?"</em>
              <br />
              to <em className="italic">"that was perfect"</em>.
            </SectionHeading>
            <p className="lede max-w-95">
              Five quiet steps. No surprises along the way.
            </p>
          </Reveal>
          ...
          <Reveal className="content-split-sticky">
              ...
              {[
                {
                  ...
                  body: "Coffee in Isleworth or video, you pick. We listen, we don't pitch. By the end, we both know if we're a fit.",
                },
                {
                  num: "02",
                  label: "Shape — week 2",
                  title: "One page. One price.",
                  body: "You get a clear plan with a fixed quote. Move things, swap things, change anything. Re-quote in 24 hours.",
                },
                {
                  num: "03",
                  label: "Source — months out",
                  title: "Vendors, venues, the lot.",
                  body: "We bring the people we trust. You meet the ones that matter. Everyone else stays invisible — by design.",
                },
                {
                  num: "04",
                  label: "Rehearse — week of",
                  title: "Walk-through & run-of-day.",
                  body: "Every minute mapped. Every contingency named. Every supplier briefed. You stop checking your phone.",
                },
                {
                  num: "05",
                  label: "Run — day 0",
                  title: "You arrive as a guest.",
                  body: "Your only job is to be present. We hold the room behind you, in earpieces, so quietly you forget we're there.",
                },
              ].map((s) => (
            ...
            <div className="process-sidebar">
              <div
                className="ph dark image-4-5"
                data-label="Process · planner at venue"
              />
      ...
      <div className="marquee">
        <div className="marquee-track">
          ...
          <span className="ital">Birthdays</span>
          <span className="dot">
            <IconSeparatorDot className="icon-marquee-dot" aria-hidden="true" />
          </span>
          <span>Corporate launches</span>
          <span className="dot">
            <IconSeparatorDot className="icon-marquee-dot" aria-hidden="true" />
          </span>
          <span className="ital">Kids parties</span>
          <span className="dot">
            <IconSeparatorDot className="icon-marquee-dot" aria-hidden="true" />
          </span>
          ...
          <span className="ital">Garden parties</span>
          <span className="dot">
            <IconSeparatorDot className="icon-marquee-dot" aria-hidden="true" />
          </span>
          ...
          <span className="ital">Photography</span>
          <span className="dot">
            <IconSeparatorDot className="icon-marquee-dot" aria-hidden="true" />
          </span>
          <span>Weddings</span>
            ...
            <div className="cta-split">
              <div>
                ...
                <p className="mt-6 max-w-[44ch] text-lg leading-relaxed text-ink-2">
                  It takes 90 seconds. We reply the same evening. No deposit, no
                  hard sell — just a quick honest conversation.
                </p>
              ...
              <div className="lg:text-right">
                <div className="mb-3.5 font-serif text-lg italic text-ink-2">
                  or, the old way:
                </div>
                <a
                  href={`tel:${CONTACT.phoneTel}`}
                  className="mb-[18px] block font-serif text-[clamp(28px,4vw,48px)] leading-tight text-ink"
                >
                  {CONTACT.phone}
                </a>
                <a
                  href={`mailto:${CONTACT.email}`}
                  className="block font-serif text-[22px] text-ink-2"
                >
                  {CONTACT.email}
                </a>
